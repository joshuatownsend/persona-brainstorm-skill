...
1. **Genericness findings** — a third of items are archetype boilerplate.
2. **Persona collisions** — P2 and P5 share four asks.
3. **Inferred marks** — several coverage grades are impressions.
