...
| **P1** | `executing-agent` | **The AI agent executing the method** | The subject is agent-executed by definition, so this persona is present at every invocation. Generates asks no human will: how do I detect that I under-reached, what do I do when the user contradicts what I observe, am I permitted to skip a step. | 15 |
